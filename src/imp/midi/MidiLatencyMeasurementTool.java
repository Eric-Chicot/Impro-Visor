...
public class MidiLatencyMeasurementTool
  ...
  JTable table;
    ...
    private void initComponents() {
        ...
        instructionsTextArea.setText(bundle.getString("MidiLatencyMeasurementTool.instructionsTextArea.text")); // NOI18N
        ...
        averageLabel.setText(bundle.getString("MidiLatencyMeasurementTool.averageLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        averageLatencyTF.setText(bundle.getString("MidiLatencyMeasurementTool.averageLatencyTF.text")); // NOI18N
        ...
        msLabel.setText(bundle.getString("MidiLatencyMeasurementTool.msLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jButton1.setText(bundle.getString("MidiLatencyMeasurementTool.jButton1.text")); // NOI18N
        ...
        startBtn.setText(bundle.getString("MidiLatencyMeasurementTool.startBtn.text")); // NOI18N
        ...
        titleLabel.setText(bundle.getString("MidiLatencyMeasurementTool.titleLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        if (!repeatTest) {
            ...
            startBtn.setText(bundle2.getString("MidiLatencyMeasurementTool.startBtn.text2"));
        } else {
            stopLatencyMeasurement();
            startBtn.setText(bundle2.getString("MidiLatencyMeasurementTool.startBtn.text"));
        }
